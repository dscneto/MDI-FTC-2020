        ...
        <Fragment>
            ...
            <section className="Imagem">
                <div className="cuidados">
                    <h3>Durante a pandemia evite:</h3>
                    <img src="" alt="" className="cuidados"/>
                    <h4></h4>
                    <img src="" alt="" className="cuidados"/>
                    <h4></h4>
                    <img src="" alt="" className="cuidados"/>
